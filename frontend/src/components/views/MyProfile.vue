...
<template>
    <div class="relative">
        ...
        <main class="bg-white w-screen relative h-screen z-20">
            ...
            <div class="px-20">
                <SimpleTable :columns="data.columns" :rows="data.rows" :page="page" @emitNextPage="onNextPage()" @emitPreviousPage="onPreviousPage()"></SimpleTable>
            </div>

            <hr class="my-4">

            <div class="px-20">
                <DataTable :columns="data.columns" :rows="data.rows" :actions="data.actions" :multiActions="data.multiActions" :page="page" @emitNextPage="onNextPage()" @emitPreviousPage="onPreviousPage()"></DataTable>
            </div>
        </main>
    </div>
</template>