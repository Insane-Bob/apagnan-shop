        ...
        >
            ...
            <div class="flex flex-col gap-5 mt-5">
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <Slider
                        :modelValue="[filters.price.min, filters.price.max]"
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <div class="flex flex-col gap-y-1">
                        <div
                            ...
                            v-for="(collection, index) in extendCollection
                                ? collections
                        ...
                        >
                            ...
                            <label :for="collection" class="cursor-pointer">{{
                                collection
                            }}</label>
                        </div>
                        <div
                            @click="extendCollection = !extendCollection"
                        ...
                        >
                            ...
                            ></ion-icon>
                            <p>
                                {{ extendCollection ? 'Réduire' : 'Voir plus' }}
                            </p>
                        </div>
                    </div>
                </div>
