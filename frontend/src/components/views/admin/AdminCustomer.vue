...
const data = reactive({
    customer: customerData.rows.find((row: any) => row.id == route.params.id),
})
...
<template>
    <div class="mx-8">
        <div class="flex justify-between items-center">
            ...
            <router-link to="/admin/customers" class="text-blue-500"
        ...
        <div class="mt-4">
            <div class="flex flex-col justify-between">
                ...
                <div class="flex gap-x-3 items-center">
                    ...
                    <p class="font-thin">
                        {{
                            data.customer?.createdAt.toLocaleDateString(
                                'fr-FR',
                                options,
                            )
                        }}
