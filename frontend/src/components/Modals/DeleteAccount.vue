        ...
        <AlertDialogContent class="max-w-[500px] w-[50vw]">
            <AlertDialogHeader>
                ...
                <AlertDialogDescription>
                    ...
                    action est irréversible. Les données de votre compte seront
                    supprimées et vous ne pourrez plus accéder à votre compte.
                    Seule les données de facturation seront conservées pour des
                    raisons légales, chez notre préstataire Stripe.
                </AlertDialogDescription>
            </AlertDialogHeader>
            <AlertDialogFooter>
                ...
                <AlertDialogCancel class="!text-black/40" @click="cancel">
                    Je renonce
                </AlertDialogCancel>
            </AlertDialogFooter>
        </AlertDialogContent>
