...
describe("TokenServices", () => {
    ...
    test("retrieveTokenFromIdentifier", async () => {
        const tokenFromIdentifier = await TokenServices.retrieveTokenFromIdentifier(token.identifier)
    ...
    test("Generate refresh token and retreive from refresh token", async () => {
        ...
        const tokenFromRefreshToken = await TokenServices.retrieveTokenFromRefreshToken(token.refreshToken)
